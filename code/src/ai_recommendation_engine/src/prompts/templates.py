...
categories = {
    ...
    "Sentiment-Driven Content Recommendations": "3. Recommend content (videos, blogs, etc.) online links based on sentiment analysis of social media posts & customer preferences. Note: Prompt should not be included in the response",
